...
🧠 Passionate about full-stack JavaScript development, clean UI, and scalable backend systems

---

## 💼 About Me
I'm a career-switching developer with hands-on experience in building full-stack applications using React, Node.js, Django, and PostgreSQL.  
Currently completing the Northcoders bootcamp and pursuing a BSc in Computer Science at the University of London.  
I love solving real-world problems through code and collaborating in agile teams to create responsive, accessible apps.
...
**Languages:** JavaScript (ES6+), TypeScript, Python, C#, SQL, Go, C
**Frontend:** React, Next.js, Tailwind CSS, Vite, Bootstrap, Materialize  
**Backend:** Node.js, Express, Django, Flask, RESTful APIs
**Databases:** PostgreSQL, MongoDB, MySQL, Supabase
**Cloud & DevOps:** AWS (basics), Railway, Render, Vercel, Netlify, CI/CD (GitHub Actions)
**Tools & Practices:** Git/GitHub, Agile/Scrum, TDD (Jest, pytest, Supertest), Postman, Figma, Jira
**Others:** Microservices, system design, authentication & security, design systems

---

## 🧠 Learning & Growth
- 💻 Deepening backend engineering skills — Node.js, Go, C#, database performance & API design
- ☁️ Exploring cloud fundamentals (AWS, deployments, monitoring, CI/CD pipelines)
- 🎨 Improving reusable UI component patterns and scalable front-end architectures in React + Tailwind
- 🤝 Sharpening collaboration through real-world startup and freelance projects
- 🧩 Participating in hackathons, tech communities, and engineering meetups
- 🎓 Studying BSc Computer Science part-time to strengthen CS theory & problem-solving

---

## 🌐 Connect with Me
- [LinkedIn](https://www.linkedin.com/in/lauren-yeung-553134262/)
- 📫 Email: laurenyeung21717@gmail.com
